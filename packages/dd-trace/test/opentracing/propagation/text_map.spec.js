...
describe('TextMapPropagator', () => {
  ...
  describe('inject', () => {
    ...
    it('should drop trace tags if too large', () => {
      ...
      expect(spanContext._trace.tags).to.have.property('_dd.propagation_error:inject_max_size', 1)
    })
    ...
    it('should drop trace tags if invalid', () => {
      ...
      expect(carrier).to.not.have.property('x-datadog-tags')
      expect(spanContext._trace.tags).to.have.property('_dd.propagation_error:encoding_error', 1)
    })
